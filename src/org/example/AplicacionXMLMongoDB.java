...
public class AplicacionXMLMongoDB {
    ...
    public static void main(String[] args) {
        ...
        int opcion;
        try {
            conexionBaseX = ConexionBaseX.conexionBaseX();
            conexionMongoDB = ConexionMongoDB.conexionMongoDB();
            ...
            System.out.println("Error de conexión BaseX y MongoDB: " + e.getMessage());
        } finally {
            ...
            // Evita cerrar MongoDB dos veces
            if (conexionMongoDB != null) {
                try {
                    // Si ya tienes un método cerrarConexion(), úsalo y elimina este bloque
                    ConexionMongoDB.cerrarConexion();
                } catch (Exception e) {
                    System.out.println("Error cerrando la conexión con MongoDB: " + e.getMessage());
                }
                // Evita imprimir el mensaje dos veces
                conexionMongoDB = null;
            }
